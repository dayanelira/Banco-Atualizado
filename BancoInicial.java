...
public class BancoInicial {
	...
	public static void operacoes() {
        ...
        case 5:
            ...
            break;
        case 6:
        	JOptionPane.showMessageDialog(null,"Tudo certo. Obrigado por usar nossa agência!");
        	System.exit(0);
        	default:
	 ...
	 public static void depositar() {
		...
		int numeroConta =
		 ...
		 if(conta != null) {
			 Double valorDesposito =
					 Double.parseDouble(JOptionPane.showInputDialog(null,"Qual valor deseja depositar?"));
			 conta.depositar(valorDesposito);
